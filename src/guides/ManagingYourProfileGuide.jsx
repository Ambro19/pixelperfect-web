...
//
// ✅ UPDATE (May 2026 — Settings Page Overhaul):
//   The Settings page (/settings) now serves as the unified account
//   management hub. It contains:
//     - Profile Information section (Username, Email, Member Since) with
//       "Edit Profile" button that opens an inline edit form
//     - Security section (Change Password)
//     - Subscription Management section (current plan badge, Open Billing
//       Portal button, Cancel Subscription flow)
//     - Danger Zone section (Delete My Account)
//   The Dashboard → Subscription Status card also has a
//   "💳 Manage Subscription & Billing" button (paid users only) that
//   opens the Stripe Customer Portal directly from the dashboard.
//   Updated step-by-step instructions to reflect this UI.
// ========================================
...
const ManagingYourProfileGuide = () => {
  return (
    <div className="prose prose-blue max-w-none">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-blue-800 text-sm mb-0">
              How to update your profile information from the Settings page or via the API.
      ...
      <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Updating Your Profile From the Settings Page</h2>
      <p className="text-gray-700 leading-relaxed">
        The Settings page is your central hub for all account management — profile edits,
        password changes, subscription management, and account deletion. Here's how to
        update your profile:
      </p>
      ...
      <div className="space-y-4 my-6">
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          ...
          <p className="text-sm text-gray-700 mb-0 ml-9">
            From the dashboard, click <strong>⚙️ Account Settings</strong> in the Account
            Information section. Or navigate directly to{' '}
            <a href="/settings" className="text-blue-600 hover:underline">/settings</a>.
            The Settings page is also accessible by clicking your username in the top-right
            header and choosing Settings.
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h4 className="font-semibold text-gray-900 mb-0">Click "Edit Profile" in the Profile Information section</h4>
          </div>
          <p className="text-sm text-gray-700 mb-0 ml-9">
            At the top of the Settings page you'll see the <strong>Profile Information</strong>{' '}
            card showing your current Username, Email Address, and Member Since date. Click
            the <strong>✏️ Edit Profile</strong> button in the top-right corner of that card
            to open the inline edit form. You can change your Username, Email, or both.
            Fields you don't touch are left as-is.
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h4 className="font-semibold text-gray-900 mb-0">Save your changes</h4>
          </div>
          <p className="text-sm text-gray-700 mb-0 ml-9">
            Click <strong>Save</strong> in the edit form. The change applies immediately.
            You'll see a confirmation toast listing which fields were updated. If the new
            value conflicts with another account (username or email already taken), you'll
            see a clear error and the field stays editable so you can try a different value.
          </p>
        </div>
      </div>
      ...
      <div className="bg-blue-50 border-l-4 border-blue-500 p-4 my-4 rounded">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="text-sm font-semibold text-blue-900 mt-0 mb-1">What else is on the Settings page</h4>
            <p className="text-blue-800 text-sm mb-0">
              The Settings page is more than just a profile editor. It also contains the{' '}
              <strong>Security</strong> section (Change Password), the{' '}
              <strong>Subscription Management</strong> section (plan badge, billing portal,
              cancel subscription), and the <strong>Danger Zone</strong> (Delete Account).
              Everything about your account is managed from one place.
            </p>
          </div>
        </div>
      </div>
...
{`curl https://api.pixelperfectapi.net/users/me \\
  -H "Authorization: Bearer YOUR_JWT_TOKEN"`}
      ...
      <div className="space-y-4">
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          ...
          <p className="text-sm text-gray-700">
            In the Settings page, click <strong>✏️ Edit Profile</strong>, change only the Email
            field, and click Save. Your username stays exactly as it is. Via API, send only
            the <span className="font-mono">email</span> field in the request body — don't
            include <span className="font-mono">username</span> at all.
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          ...
          <p className="text-sm text-gray-700">
            This usually means the Stripe sync step failed silently. Check your Settings page —
            does your Email Address show the new value? If yes, but Stripe still shows the
      ...
      <ul className="space-y-2 text-gray-700">
        <li className="flex items-start gap-2">
          <span className="text-blue-600 font-bold mt-0.5">•</span>
          <span><strong>Password</strong> — use the <strong>Security</strong> section on the
            Settings page, or{' '}
            <a href="/help/article/password-reset" className="text-blue-600 hover:underline">
              the password reset flow
            </a>{' '}
            if you're locked out</span>
        </li>
        <li className="flex items-start gap-2">
          <span className="text-blue-600 font-bold mt-0.5">•</span>
          <span><strong>Subscription tier</strong> — use the <strong>Subscription Management</strong>{' '}
            section on the Settings page, or see{' '}
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-green-800 text-sm mb-0">
              You know what's in your profile, what you can change (via Settings page or API),
              what happens automatically when you change it (Stripe email sync, JWT invalidation),
              and how to handle the common edge cases. Profile changes are immediate — no email
              verification step, no waiting period. Everything else about your account — password,
              subscription, account deletion — is also managed from the same Settings page.
            </p>
          </div>
        </div>
      </div>
