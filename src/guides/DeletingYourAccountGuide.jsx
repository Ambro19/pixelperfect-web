...
//   - Settings page (/settings) has account deletion in the Danger Zone
//     section at the bottom. The confirmation phrase typed into the field
//     is "DELETE" (not "DELETE MY ACCOUNT" — that is the cancel
//     subscription phrase). The button reads "Permanently Delete Account".
...
//   - Step 1 "Open the dashboard" was WRONG. The Danger Zone lives on
//     the Settings page (/settings), not the main dashboard. Updated to
//     "Open the Settings page."
//   - Step 3 confirmation phrase was documented as "DELETE MY ACCOUNT"
//     (that is the cancel-subscription phrase). The actual deletion
//     confirmation field requires typing "DELETE". Fixed in steps 3 & 4
//     and all cross-references.
//   - The dashboard does NOT have a delete button. Corrected scope note.
//
      ...
      <div className="space-y-4 my-6">
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          ...
          <p className="text-sm text-gray-700 mb-0 ml-9">
            ...
            Scroll to the bottom of the page. You'll see a <strong>⚠️ Danger Zone</strong>{' '}
            section with a <strong>Delete Account Permanently</strong> heading and a red{' '}
            <strong>🗑️ Delete My Account</strong> button — deliberately separated from the rest
            of the settings so it's hard to reach by accident.
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h4 className="font-semibold text-gray-900 mb-0">Click "Delete My Account"</h4>
          </div>
          <p className="text-sm text-gray-700 mb-0 ml-9">
            The Danger Zone section expands inline to show the confirmation UI. It lays out
            exactly what's about to happen — your account, screenshots, API keys, batch jobs,
            and subscription data will all be permanently deleted. Read this carefully — it's
            the last clear stop before the point of no return.
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          ...
          <p className="text-sm text-gray-700 mb-0 ml-9">
            The confirmation field asks you to type{' '}
            <span className="font-mono font-bold">DELETE</span> exactly (uppercase). The{' '}
            <strong>Permanently Delete Account</strong> button stays disabled until the word
            is typed correctly. This typed confirmation is the safety net against autofill,
            accidental clicks, and rage-clicks during frustrating moments.
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h4 className="font-semibold text-gray-900 mb-0">Click "Permanently Delete Account"</h4>
          </div>
          <p className="text-sm text-gray-700 mb-0 ml-9">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-red-800 text-sm mb-0">
              ...
              from backups. The cascade fires the moment you click Permanently Delete Account,
              and we cannot walk it back. This is intentional — it's how data deletion is
              supposed to work under privacy regulations, and it's how we'd want our own
              accounts handled.
            </p>
          </div>
        </div>
...
{`curl -X DELETE https://api.pixelperfectapi.net/user/delete-account \\
  -H "Authorization: Bearer YOUR_JWT_TOKEN"`}
      ...
      <p className="text-gray-700 leading-relaxed mt-3">
        ...
        typed-confirmation gate — that's a UX safeguard for the Settings page. If you're
        calling the API directly, we assume you know what you're doing and have your own
        confirmation flow appropriate to your context.
      </p>

      {/* What happens behind the scenes */}
      <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">What Happens When You Click Permanently Delete Account</h2>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-green-800 text-sm mb-0">
              You know which alternatives to consider before deleting, the deletion flow
              (Settings → Danger Zone → Delete My Account → type DELETE → Permanently Delete
              Account), the cascade of what gets removed, and what persists for legal reasons.
