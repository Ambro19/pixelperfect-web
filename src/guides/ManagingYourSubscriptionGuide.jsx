...
//
// ✅ FIX (May 2026 — Settings Page Overhaul):
//    Updated all references to match the current UI:
//    - "Downgrading Your Plan": the portal is opened via the
//      "Open Billing Portal" button in Settings → Subscription Management
//      (not a generic "Manage Billing" button). The Dashboard also has a
//      "💳 Manage Subscription & Billing" button for paid users.
//    - "Cancelling Your Subscription": the Cancel Subscription flow now
//      lives in Settings → Subscription Management, not on the dashboard.
//      Step 1 updated accordingly. The confirmation phrase is
//      "CANCEL MY SUBSCRIPTION" (typed in full, uppercase).
//    - General: "dashboard" → "Settings page" wherever the action
//      actually happens in /settings.
//
// Article serves both:
  ...
  return (
    <div className="prose prose-blue max-w-none">
      ...
      <p className="text-gray-700 leading-relaxed">
        Your subscription details live in two places. On the <strong>dashboard</strong>,
        the <strong>Subscription Status</strong> card shows your current tier, your usage
        this month against the tier's quota, and the date your billing cycle resets. Paid
        users also see a <strong>💳 Manage Subscription &amp; Billing</strong> button there
        that opens the Stripe Customer Portal directly.
      </p>
      <p className="text-gray-700 leading-relaxed mt-3">
        For full subscription management — upgrading, downgrading, cancelling, or opening
        the billing portal — go to the <strong>Settings page</strong>{' '}
        (<a href="/settings" className="text-blue-600 hover:underline">/settings</a>).
        The <strong>Subscription Management</strong> section shows your current plan badge,
        an <strong>Open Billing Portal</strong> button, and (for paid users) a{' '}
        <strong>Cancel Subscription</strong> flow. From there, you can also navigate to{' '}
        <a href="/pricing" className="text-blue-600 hover:underline">/pricing</a> to compare
        tiers and trigger an upgrade.
      </p>
      <p className="text-gray-700 leading-relaxed mt-3">
      ...
      <p className="text-gray-700 leading-relaxed">
        Downgrades are handled through the Stripe Customer Portal. There are two ways to
        open it:
      </p>
      <ul className="space-y-2 mt-3 mb-4 text-gray-700">
        <li className="flex items-start gap-2">
          <span className="text-blue-600 font-bold mt-0.5">•</span>
          <span><strong>From the Settings page</strong> — go to{' '}
            <a href="/settings" className="text-blue-600 hover:underline">/settings</a>,
            scroll to the <strong>Subscription Management</strong> section, and click{' '}
            <strong>Open Billing Portal</strong>.</span>
        </li>
        <li className="flex items-start gap-2">
          <span className="text-blue-600 font-bold mt-0.5">•</span>
          <span><strong>From the dashboard</strong> (paid users only) — click the{' '}
            <strong>💳 Manage Subscription &amp; Billing</strong> button in the
            Subscription Status card.</span>
        </li>
      </ul>
      <p className="text-gray-700 leading-relaxed">
        Once in the portal, select a lower tier. Stripe prorates the change &mdash; you receive
        a credit for the unused portion of your current tier and a charge for the new tier
      ...
      <p className="text-gray-700 leading-relaxed">
        ...
        Portal — open it from Settings → Subscription Management → <strong>Open Billing Portal</strong>,
        or from the dashboard's <strong>💳 Manage Subscription &amp; Billing</strong> button
        (paid users). Annual billing saves roughly 20% compared to 12 months of monthly billing.
      ...
      <div className="space-y-4 my-6">
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          ...
          <p className="text-sm text-gray-700 mb-0 ml-9">
            Navigate to <a href="/settings" className="text-blue-600 hover:underline">/settings</a>.
            Scroll to the <strong>Subscription Management</strong> section. You'll see your
            current plan badge and a <strong>Cancel Subscription</strong> button below the
            billing portal option. (Free tier users will see a message that there's no paid
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          ...
          <p className="text-sm text-gray-700 mb-0 ml-9">
            A confirmation panel expands listing exactly what happens: you retain access
            until the end of your current billing period, then drop to Free (100
            screenshots/month), and your API keys, settings, and history are preserved.
            Type <code className="font-mono">CANCEL MY SUBSCRIPTION</code> in the confirmation
            field to enable the <strong>Confirm Cancellation</strong> button. This prevents
            accidental cancellations. Once confirmed, Stripe schedules the cancellation for
      ...
      <ul className="space-y-3 mt-4 text-gray-700">
        <li className="flex items-start gap-2">
          ...
          <span>
            <strong>Past invoices</strong> are accessible via the Stripe Customer Portal.
            Open it from Settings → Subscription Management → <strong>Open Billing Portal</strong>,
            or from the dashboard's <strong>💳 Manage Subscription &amp; Billing</strong> button
            (paid users only).
          </span>
        </li>
        ...
        <li className="flex items-start gap-2">
          <span className="text-blue-600 font-bold mt-0.5">&bull;</span>
          <span>
            <strong>Update your payment method</strong> via the Stripe Customer Portal (same
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-green-800 text-sm mb-0">
              ...
              or switch billing cadence (Settings → Subscription Management → Open Billing Portal,
              or Dashboard → 💳 Manage Subscription &amp; Billing), and cancel (Settings →
              Subscription Management → Cancel Subscription → type CANCEL MY SUBSCRIPTION →
