...
//
// ✅ FIX (Apr 30, 2026): Rule 1 code blocks were using plain white/light
//    background (bg-white border-red-200 / border-green-200) which rendered
//    as washed-out, unreadable boxes on production (Image 1 in bug report).
//    All code blocks in this guide now use the standard dark bg-gray-900
//    with green monospace text, matching every other guide in the codebase.
//    The ❌ / ✅ labels are preserved above each block.
//    Rule 2 proxy-pattern block and Rule 5 log-strip block also upgraded.
// ========================================
...
const ApiKeyBestPracticesGuide = () => {
  return (
    <div className="prose prose-blue max-w-none">
      ...
      <div className="space-y-4 my-6">
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          ...
          <p className="text-sm text-gray-700 mb-0 ml-9">
            Each key is the prefix <code className="font-mono">pk_</code> followed by 32
            hexadecimal characters generated from a cryptographically secure random source —
            <code className="font-mono"> pk_a1b2c3d4e5f6...</code>. That's 128 bits of entropy.
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          ...
          <p className="text-sm text-gray-700 mb-0 ml-9">
            ...
            <code className="font-mono">Authorization: Bearer pk_...</code>, we hash the key
      ...
      {/* ✅ FIXED: dark code blocks matching rest of codebase */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
        <div>
          ...
          <div className="bg-gray-900 rounded-lg p-4 overflow-x-auto">
            <pre className="text-red-400 text-xs font-mono leading-relaxed">
{`// app.js
  ...
  // ...
        ...
        <div>
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="font-semibold text-green-700 text-sm">Do this instead</span>
          </div>
          <div className="bg-gray-900 rounded-lg p-4 overflow-x-auto">
...
PIXELPERFECT_API_KEY=pk_a1b2c3d4...`}
            </pre>
          </div>
        </div>
      </div>
      ...
      <p className="text-gray-700 leading-relaxed mt-3">
        Make sure <code className="font-mono">.env</code> is in your <code className="font-mono">.gitignore</code>.
        Add an <code className="font-mono">.env.example</code> file with empty placeholder
      ...
      <h4 className="text-sm font-semibold text-gray-700 mt-4 mb-2">The right pattern:</h4>
      <div className="bg-gray-900 rounded-lg p-4 my-3 overflow-x-auto">
        <pre className="text-green-400 text-sm font-mono">
{`Browser  →  YOUR backend  →  PixelPerfect API
            (key lives here)
      ...
      <p className="text-gray-700 leading-relaxed">
        ...
        auto-redact known secret names, but commands like <code className="font-mono">echo $API_KEY</code>{' '}
      ...
      <p className="text-gray-700 leading-relaxed">
        ...
        the <code className="font-mono">Authorization</code> header writes your key into log
...
logger.error("Screenshot failed", { url, headers: safeHeaders, status });`}
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-5">
        <ul className="space-y-2 text-sm text-gray-700">
          {[
            'The key is in an environment variable, not source code',
            '.env is in .gitignore',
            'The key is server-side only — never exposed to browsers or mobile apps',
            'This environment uses its own key, distinct from other environments',
            'The key has a descriptive name in the PixelPerfect dashboard',
            'Logging code strips the Authorization header before writing',
            'You know how to rotate this key without downtime if needed',
          ].map((item, i) => (
      ...
      <div className="grid grid-cols-1 gap-4">
        <a href="/help/article/data-retention-policy"
        ...
        <a href="/help/article/account-security"
        ...
        <a href="/help/article/api-authentication-methods"
