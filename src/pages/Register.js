// ========================================
// REGISTER PAGE - PRODUCTION READY (NEXT REDIRECT FIXED)
// ========================================
...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ✅ After signup, go to `next` if provided, otherwise /dashboard
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14 sm:h-16">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              {/* Preserve `next` when going to login */}
              <button
                onClick={() =>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-6 sm:p-8">
              ...
              <ul className="space-y-2 text-xs sm:text-sm">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-gray-700">
                    <strong>100 free screenshots</strong> per month
                  </span>
                </li>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">Min 8 characters, max 128 characters</p>
              </div>
