...
// Updated: April 2026
//   ✅ Mobile layout aligned with Documentation.jsx
...
//   ✅ FIX (Apr 2026): "Dashboard" button now styled as solid blue to match
//      the "Manage Plan" button pattern used throughout the app. Previously
//      it rendered as plain text which was visually inconsistent.
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14 sm:h-16">
            ...
            {/* ── ✅ FIX: Dashboard button now uses the same solid blue style  ── */}
            {/*    as "Manage Plan" on BatchJobs and other authenticated pages.  ── */}
            {/*    Previously: plain text link — visually inconsistent.           ── */}
            {/*    Now: bg-blue-600 rounded-lg — matches the app's button system. ── */}
            <div className="flex items-center gap-2 sm:gap-3">
              {isAuthenticated ? (
                <button
                  onClick={() => navigate('/dashboard')}
                  className="px-4 sm:px-5 py-1.5 sm:py-2 bg-blue-600 text-white text-sm font-semibold
                ...
                <>
                  <button
                    ...
                    className="hidden sm:block px-3 sm:px-4 py-1.5 sm:py-2 text-sm font-medium
                  ...
                  <button
                    ...
                    className="px-4 sm:px-6 py-1.5 sm:py-2 text-sm sm:text-base bg-blue-600
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          {!isAuthenticated && (
            <div className="mt-6 sm:mt-8">
              <button
                onClick={() => navigate('/register')}
                className="w-full sm:w-auto bg-blue-600 text-white px-6 sm:px-8 py-2.5 sm:py-3
              ...
              {[
                ...
                >
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="flex-shrink-0 bg-green-100 text-green-800 px-2.5 py-1
                                     rounded font-mono text-xs sm:text-sm font-semibold">
                      POST
                    </span>
  ...
  "created_at": "2026-01-07T12:00:00Z"
        ...
        {!isAuthenticated && (
          <div className="bg-blue-600 rounded-lg p-6 sm:p-8 text-center text-white">
            ...
            <button
              onClick={() => navigate('/register')}
              className="w-full sm:w-auto px-6 sm:px-8 py-2.5 sm:py-3 bg-white text-blue-600
                         rounded-lg text-sm sm:text-lg font-semibold hover:bg-gray-100
