...
// - Robust parsing across common field names created_at / createdAt / member_since, etc.
// ============================================================================
...
export default function DashboardPage() {
  ...
  // Fallback if user data unavailable
  if (!user) {
    return (
  ...
  // ✅ Batch processing available for all paid tiers (pro, business, premium)
  const isBatchAvailable = tier !== "free";

  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header with PixelPerfect Logo */}
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        {/* ✅ Centered Page Header with Logo */}
        <div className="text-center mb-6 sm:mb-8">
          {/* Centered PixelPerfect logo icon */}
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            {/* ✅ Batch Processing - Disabled for free tier */}
            <QuickAction
