...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setStatus('error');
      setErrorMessage(err.message || 'Something went wrong. Please email us directly at onetechly@gmail.com.');
    }
  };
                ...
                <div>
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      ...
                      <a href="mailto:onetechly@gmail.com" className="text-sm text-blue-600 hover:underline">onetechly@gmail.com</a>
                    </div>
                  </div>
