...
// // Author: OneTechly
// // Purpose: Mobile-first API documentation
// // Updated: January 2026 - FIXED CODE VISIBILITY IN API ENDPOINTS
...
//                   </h3>
//                   <div className="bg-gray-900 rounded-lg p-3 sm:p-4 overflow-x-auto">
//                     <pre className="text-xs sm:text-sm text-gray-100 whitespace-pre"><code>{`curl -X POST https://api.pixelperfectapi.net/v1/screenshot \\
//   -H "Authorization: Bearer YOUR_API_KEY" \\
//   -H "Content-Type: application/json" \\
//   -d '{
//     "url": "https://example.com",
...
//               </p>
//               <div className="bg-gray-900 rounded-lg p-3 sm:p-4 mb-4 overflow-x-auto">
//                 <pre className="text-xs sm:text-sm text-gray-100"><code>Authorization: Bearer YOUR_API_KEY</code></pre>
//               </div>
//               <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
//                 <p className="text-xs sm:text-sm text-yellow-800">
//                   <strong>⚠️ Keep your API key secure!</strong> Never expose it in 
...
//             {/* API Endpoints Section - FIXED CODE VISIBILITY */}
//             <div id="endpoints" className="mb-8 sm:mb-12">
//               <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">
//                 API Endpoints
//               </h2>
...
//                   Request Body:
//                 </h4>
//                 <div className="bg-gray-50 rounded p-3 mb-4 overflow-x-auto">
//                   <pre className="text-xs sm:text-sm text-gray-800"><code>{`{
//   "url": "https://example.com",
//   "width": 1920,
//   "height": 1080,
//   "format": "png",
...
// console.log(screenshot.data.screenshot_url);`}</code></pre>
//                 </div>
//               </div>
...
// data = response.json()
// print(data['screenshot_url'])`}</code></pre>
//                 </div>
//               </div>
//             </div>
...
// // Author: OneTechly
// // Purpose: Mobile-first API documentation
// // Updated: January 2026 - MOBILE OPTIMIZED + FIXED CODE VISIBILITY
...
//                     2. Make your first request
//                   </h3>
//                   <div className="bg-gray-900 text-white rounded-lg p-3 sm:p-4 overflow-x-auto">
...
//                 API key in the Authorization header:
//               </p>
//               <div className="bg-gray-900 text-white rounded-lg p-3 sm:p-4 mb-4 overflow-x-auto">
...
//                     POST
//                   </span>
//                   <code className="text-sm sm:text-lg font-mono break-all">/v1/screenshot</code>
//                 </div>
//                 <p className="text-sm sm:text-base text-gray-700 mb-4">
//                   Capture a screenshot of any website.
//                 </p>
...
//                     POST
//                   </span>
//                   <code className="text-sm sm:text-lg font-mono break-all">/v1/batch/submit</code>
//                 </div>
//                 <p className="text-sm sm:text-base text-gray-700 mb-4">
//                   Capture multiple screenshots in one request (Pro+ only).
//                 </p>
