      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mt-4"><strong>Duration:</strong> Up to 2 years</p>
            <p className="text-gray-700 leading-relaxed mt-2"><strong>Can be disabled:</strong> Yes - through browser settings or cookie preferences</p>
            ...
            <p className="text-gray-700 leading-relaxed mt-4"><strong>Duration:</strong> Up to 1 year</p>
            <p className="text-gray-700 leading-relaxed mt-2"><strong>Can be disabled:</strong> Yes - but some features may not work properly</p>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full bg-white border border-gray-200 rounded-lg">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider border-b">Cookie Name</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider border-b">Purpose</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider border-b">Duration</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider border-b">Type</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200">
                  <tr><td className="px-6 py-4 text-sm text-gray-900">session_token</td><td className="px-6 py-4 text-sm text-gray-700">Maintains your logged-in session</td><td className="px-6 py-4 text-sm text-gray-700">30 days</td><td className="px-6 py-4 text-sm text-gray-700">Essential</td></tr>
                  <tr><td className="px-6 py-4 text-sm text-gray-900">csrf_token</td><td className="px-6 py-4 text-sm text-gray-700">Protects against cross-site request forgery</td><td className="px-6 py-4 text-sm text-gray-700">Session</td><td className="px-6 py-4 text-sm text-gray-700">Essential</td></tr>
                  <tr><td className="px-6 py-4 text-sm text-gray-900">api_token</td><td className="px-6 py-4 text-sm text-gray-700">Authenticates API requests</td><td className="px-6 py-4 text-sm text-gray-700">90 days</td><td className="px-6 py-4 text-sm text-gray-700">Essential</td></tr>
                  <tr><td className="px-6 py-4 text-sm text-gray-900">user_prefs</td><td className="px-6 py-4 text-sm text-gray-700">Stores your preferences and settings</td><td className="px-6 py-4 text-sm text-gray-700">1 year</td><td className="px-6 py-4 text-sm text-gray-700">Functional</td></tr>
                  <tr><td className="px-6 py-4 text-sm text-gray-900">_analytics_id</td><td className="px-6 py-4 text-sm text-gray-700">Tracks anonymous usage statistics</td><td className="px-6 py-4 text-sm text-gray-700">2 years</td><td className="px-6 py-4 text-sm text-gray-700">Analytics</td></tr>
                  <tr><td className="px-6 py-4 text-sm text-gray-900">cookie_consent</td><td className="px-6 py-4 text-sm text-gray-700">Remembers your cookie preferences</td><td className="px-6 py-4 text-sm text-gray-700">1 year</td><td className="px-6 py-4 text-sm text-gray-700">Essential</td></tr>
                </tbody>
              </table>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mb-3">Most web browsers allow you to control cookies through their settings. You can:</p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
            ...
            <div className="space-y-3">
              <div className="bg-gray-50 rounded p-4">
                <p className="text-gray-700"><strong>Chrome:</strong> Settings → Privacy and security → Cookies and other site data<br /><a href="https://support.google.com/chrome/answer/95647" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline text-sm">support.google.com/chrome/answer/95647</a></p>
              </div>
              <div className="bg-gray-50 rounded p-4">
                <p className="text-gray-700"><strong>Firefox:</strong> Options → Privacy & Security → Cookies and Site Data<br /><a href="https://support.mozilla.org/en-US/kb/enhanced-tracking-protection-firefox-desktop" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline text-sm">support.mozilla.org/en-US/kb/enhanced-tracking-protection</a></p>
              </div>
              <div className="bg-gray-50 rounded p-4">
                <p className="text-gray-700"><strong>Safari:</strong> Preferences → Privacy → Cookies and website data<br /><a href="https://support.apple.com/guide/safari/manage-cookies-sfri11471/mac" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline text-sm">support.apple.com/guide/safari/manage-cookies</a></p>
              </div>
              <div className="bg-gray-50 rounded p-4">
                <p className="text-gray-700"><strong>Edge:</strong> Settings → Privacy, search, and services → Cookies<br /><a href="https://support.microsoft.com/en-us/microsoft-edge/delete-cookies-in-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline text-sm">support.microsoft.com/en-us/microsoft-edge</a></p>
              </div>
            </div>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mb-3">Disabling cookies may affect your ability to use certain features of our website:</p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mb-3">To learn more about cookies and how they work, you can visit these resources:</p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">This Cookie Policy should be read in conjunction with our:</p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2 mt-3">
              <li><button onClick={() => navigate('/privacy')} className="text-blue-600 hover:underline">Privacy Policy</button> - How we collect, use, and protect your data</li>
              <li><button onClick={() => navigate('/terms')} className="text-blue-600 hover:underline">Terms of Service</button> - Terms governing your use of our service</li>
            </ul>
          </section>
