...
//   Replaced the 💬 emoji icon with PixelPerfectLogo above the title.
//   Pattern matches all other app pages (ForgotPassword, Register,
//   DashboardPage, etc.): logo centered above the h1, no emoji.
//   The emoji was visually inconsistent with the rest of the product.
//
...
export default function Community() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero — logo above title, matching ForgotPassword / Register pattern */}
      <section className="bg-gradient-to-b from-green-50 to-white py-16 sm:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">

          {/* ✅ FIX: PixelPerfectLogo replaces the 💬 emoji — matches all other pages */}
