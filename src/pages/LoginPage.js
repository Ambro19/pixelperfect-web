// // ========================================
// // REGISTER PAGE - PRODUCTION READY (DROP-IN)
// // ========================================
...
// //
// // Improvements:
// // ✅ No window.innerWidth during render (stable)
// // ✅ Preserves ?next=... through Login/Register
// // ✅ Double-submit guard
// // ✅ Clearer error normalization
// // ========================================
...
//   if (qNext) return safeNextPath(qNext);
...
//   if (typeof sNext === "string") return safeNextPath(sNext);
...
//   const nextPath = useMemo(() => getNextPath(location), [location]);
...
//   const loginLink = `/login?next=${encodeURIComponent(nextPath)}`;
...
//                 <button onClick={() => navigate(loginLink)} className="text-blue-600 hover:text-blue-700 font-semibold">
//                   Sign in
//                 </button>
//               </p>
//             </div>
