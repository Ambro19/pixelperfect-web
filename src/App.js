...
// Updated: July 2026
//
// ✅ CHANGES IN THIS VERSION (July 2026):
//   - Added /careers route → Careers.jsx placeholder page
//     (was returning 404 from Marketing.jsx footer link)
//   - Added /community route → Community.jsx hub page
//     (was pointing to community.pixelperfapi.net which DNS-resolved to nothing)
//
// Previous changes (retained):
// ✅ April 2026: Added Help Center article detail + category view routing
// ✅ April 2026: Added ArticleDetail and CategoryView components
// ✅ April 2026: Added ForgotPassword and ResetPassword routes
// ========================================
  ...
  return (
    <ErrorBoundary>
      <Routes>
        ...
        {/* ✅ NEW July 2026: Careers page (was 404) */}
        <Route path="/careers"   element={<Careers />} />

        {/* ✅ NEW July 2026: Community hub page (replaces broken subdomain) */}
